...
export const UPDATE_PACKAGE_CATEGORY_ACTION = "update-package-category-action";
...
export const LIST_SHOW_BOOK = [LIST_CATE.CATEGORY, LIST_CATE.SERVICES, LIST_CATE.PARTY_PACKAGES, LIST_CATE.VENUE, LIST_CATE.CART]
