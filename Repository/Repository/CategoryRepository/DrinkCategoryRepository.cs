...
namespace Repository.Repository.CategoryRepository
{
    public class DrinkCategoryRepository : IDrinkCategoryRepository
    {
        ...
        public DrinkCategory GetDrinkCategoryById(int id) => DrinkCategoryDAO.findDrinkCategoryById(id);

        public List<DrinkCategory> GetDrinkCategoryByName(string DrinkCategoryName) => DrinkCategoryDAO.findDrinkCategoryByName(DrinkCategoryName);
