    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicePackageImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServicePackageImages_ServicePackages_ServicePackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueCombos", x => new { x.VenueId, x.ComboId });
                    table.ForeignKey(
                        name: "FK_VenueCombos_Combos_ComboId",
                        column: x => x.ComboId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueServicePackages", x => new { x.VenueId, x.ServicePackageId });
                    table.ForeignKey(
                        name: "FK_VenueServicePackages_ServicePackages_ServicePackageId",
                        column: x => x.ServicePackageId,
                        principalTable: "ServicePackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VenueServicePackages_Venues_VenueId",
                        column: x => x.VenueId,
                        principalTable: "Venues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueFoods", x => new { x.VenueId, x.FoodId });
                    table.ForeignKey(
                        name: "FK_VenueFoods_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VenueFoods_Venues_VenueId",
                        column: x => x.VenueId,
                        principalTable: "Venues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicePackageDetails", x => new { x.ServiceId, x.ServicePackageId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServicePackageDetails_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueServices", x => new { x.VenueId, x.ServiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServicePackageQuantity = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingDetails", x => new { x.BookingId, x.FoodId, x.ComboId, x.ServiceId, x.ServicePackageId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingDetails_ServicePackageId",
                table: "BookingDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicePackageImages_ServicePackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VenueCombos_ComboId",
                table: "VenueCombos",
                column: "ComboId");

            migrationBuilder.CreateIndex(
                name: "IX_VenueFoods_FoodId",
                table: "VenueFoods",
                column: "FoodId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VenueServicePackages_ServicePackageId",
                table: "VenueServicePackages",
                column: "ServicePackageId");
